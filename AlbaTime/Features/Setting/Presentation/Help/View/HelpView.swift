...
struct HelpView: View {
    ...
    let faqs: [FAQItem] = [
        ...
        FAQItem(
            ...
            answer: "위 금액은 입력된 근무 시간을 기준으로 계산된 예상 금액으로, 실제 급여와 차이가 발생할 수 있습니다. 비고정 근무는 저장된 스케줄을 기반으로 남은 기간의 근무 시간을 예측하여 계산하므로 실제 급여와의 오차가 더 클 수 있습니다.\n또한 카드를 터치하면 누적 급여와 월 예상 급여를 전환하여 확인할 수 있습니다."
        ),
        
        FAQItem(
            question: "알림이 울리지 않아요.",
            answer: "설정 > 알림 설정에서 '알림 설정'이 켜져 있는지 확인해 주세요.\n\n또한 아이폰 설정 > 알림 > 알바타임에서 알림 권한이 허용되어 있어야 정상적으로 작동합니다."
        ),
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 16) {
                    ...
                    Button {
                        openURL(SettingExternalLink.kakaoOpenChat)
                    } label: {
                        HStack {
