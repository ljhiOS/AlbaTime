...
enum JobFeatureComposition {
    ...
    static func makeEditingSeed(from workplace: Workplace) -> JobEditingSeed {
        JobEditingSeed(
            id: workplace.id,
    ...
    static func makeCardState(from workplace: Workplace) -> JobCardViewState {
        JobCardViewState(
            id: workplace.id,
            name: workplace.name,
    ...
    static func makeDetailState(from workplace: Workplace) -> JobDetailViewState {
...
private extension JobFeatureComposition {
